...
def _clean_env(monkeypatch):
    ...
    monkeypatch.setattr("gateway.config_helpers.load_raw_gateway_config", lambda: {}, raising=False)
...
def test_projection_none_when_all_default(monkeypatch):
    ...
    monkeypatch.setenv("GATEWAY_RELAY_PLATFORMS", "discord")
    monkeypatch.setattr("gateway.config_helpers.load_raw_gateway_config", lambda: {"discord": {}}, raising=False)
